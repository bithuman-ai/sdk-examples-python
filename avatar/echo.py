...
async def read_audio_from_microphone(
    runtime: AsyncBithuman, audio_io: LocalAudioIO, slient_threshold_db: int = -40
) -> None:
...
async def run_bithuman(runtime: AsyncBithuman) -> None:
